...
class IHumbak_Updater_ihumbak_tax_calculator {
  ...
  private $ihumbak_plugin_name = 'ihumbak-tax-calculator';
  private $ihumbak_plugin_current_version = '0.4';
...
new IHumbak_Updater_ihumbak_tax_calculator();